window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const link = { color: "var(--dsw-alias-state-business-primary, #2563eb)" };
		const input = {
			padding: "var(--dsw-spacing-2, 8px)",
			border: "1px solid var(--dsw-alias-border-l3, #d0d5dd)",
		...
		function Card({ store, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: hint,
						children: t(mode === "api" ? "apiHint" : "codingHint")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						style: column,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
							...
							style: link,
							href: "https://docs.bigmodel.cn/cn/coding-plan/mcp/search-mcp-server",
							target: "_blank",
							rel: "noreferrer",
							children: t("zhipuGuide")
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
						...
						children: [
							...
							mode === "coding-plan" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										disabled,
										style: button,
										onClick: () => store.edit("mcpURL", "https://api.z.ai/api/mcp/web_search_prime/mcp"),
										children: t("useZai")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										disabled,
										style: button,
										onClick: () => store.edit("mcpURL", "https://open.bigmodel.cn/api/mcp/web_search_prime/mcp"),
										children: t("useZhipu")
									})]
								})
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								style: {
									...button,
									background: "var(--dsw-alias-button-primary-fill, #2970ff)",
